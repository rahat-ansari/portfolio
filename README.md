...
Dhaka, Bangladesh  
- Developed responsive UIs using HTML, CSS, SCSS, Vue.js, React.js, and TypeScript
- Implemented backend solutions with Laravel/Lumen, Next.js, and Express.js
- Managed database systems including MySQL, PostgreSQL, and MongoDB
- Performed requirement analysis, feature development, bug fixes, and OWASP-based pentesting

### Software Engineer  
**Aan-Nahl Software Ltd.** | Oct 2016 – Sep 2019  
Dhaka, Bangladesh  
